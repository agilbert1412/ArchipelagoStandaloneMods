...
namespace MultiSleep.Integrations.GenericModConfigMenu
{
    ...
    class GenericModConfig
    {
        ...
        public void RegisterConfig()
        {
            ...
            configMenu.AddNumberOption(
                mod: ModManifest,
                name: () => "MultiSleep Cost Per Day",
                tooltip: () => "Price in gold to pay for every day of automatic Multisleeping. If you run out of gold, you wake up.",
                min: 0,
                max: 500,
                interval: 1,
                getValue: () => Config.MultiSleepCostPerDay,
                setValue: (value) => Config.MultiSleepCostPerDay = value,
