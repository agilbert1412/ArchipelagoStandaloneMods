...
{
    public class DiscordWrapper : IBotCommunicator
    {
        ...
        public DiscordWrapper(IMonitor logger)
        {
            _logger = logger;
        }
        ...
        public async Task Start(Func<SocketMessage, Task> messageReceivedFunction)
        {
