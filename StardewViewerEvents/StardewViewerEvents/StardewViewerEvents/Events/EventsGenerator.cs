...
public class EventsGenerator
{
    public List<ViewerEvent> GenerateDefaultEvents()
    {
        var events = new List<ViewerEvent>
        {
            ...
            CreateEvent(EventName.BOMB, Alignment.NEGATIVE, 50, "Spawn a medium lit bomb", false),
            CreateEvent(EventName.BIG_BOMB, Alignment.NEGATIVE, 80, "Spawn a large lit bomb", false),

            CreateEvent(EventName.SOUND_MEOW, Alignment.NEUTRAL, 1, "Play a series of meows", true),
            CreateEvent(EventName.SOUND_BARK, Alignment.NEUTRAL, 1, "Play a series of barks", true),
            CreateEvent(EventName.SOUND_SPECIFIC, Alignment.NEUTRAL, 1, "Play a sound of your choice. Must use a stardew internal sound name, or 'random'", false, true),

            CreateEvent(EventName.FISH_BITE, Alignment.NEUTRAL, 10, "Trigger an immediate fish bite, regardless of fishing or not", false),
