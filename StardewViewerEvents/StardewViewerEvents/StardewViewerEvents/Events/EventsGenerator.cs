...
public class EventsGenerator
{
    public List<ViewerEvent> GenerateDefaultEvents()
    {
        var events = new List<ViewerEvent>
        {
            ...
            CreateEvent(EventName.ITEM_GET_RANDOM, Alignment.POSITIVE, 10, "Give a random item", true),
            ...
            CreateEvent(EventName.ITEM_GET_EXOTIC, Alignment.NEGATIVE, 10, "Give an Exotic Double Bed", true),

            CreateEvent(EventName.ITEM_HOME, Alignment.NEUTRAL, 5, "Send a random item home", true),
            ...
            CreateEvent(EventName.SPAWN_MONSTER_RANDOM, Alignment.NEGATIVE, 5, "Spawn random monster", true),
            CreateEvent(EventName.SPAWN_MONSTER_SPECIFIC, Alignment.NEGATIVE, 10, "Spawn specific monster", false, true),
            CreateEvent(EventName.TEMPORARY_BABY, Alignment.NEGATIVE, 1, "Spawn a temporary baby", true),
            ...
            CreateEvent(EventName.DEBRIS_RANDOM, Alignment.NEGATIVE, 2, "Spawn a random piece of debris nearby", true),
            ...
            CreateEvent(EventName.SOUND_MEOW, Alignment.NEUTRAL, 1, "Play a meow", true),
            CreateEvent(EventName.SOUND_BARK, Alignment.NEUTRAL, 1, "Play a bark", true),
            ...
            CreateEvent(EventName.INVISIBLE_COWS, Alignment.NEGATIVE, 2, "Spawn one invisible cow on the current map", true),
        };
